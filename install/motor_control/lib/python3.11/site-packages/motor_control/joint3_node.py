...
class Joint3Driver(Node):
    ...
    def pid_worker(self):
        ...
        MAX_HZ = 6500.0       # ⬆️ เพิ่มความเร็วสูงสุด (2000 Hz = วิ่งประมาณ 1.2 รอบ/วินาที)
        MIN_HZ = 50.0        # ⬆️ เพิ่มความเร็วต่ำสุด เลี้ยงรอบไว้ไม่ให้หยุดกระชาก
        ACCEL_RATE = 450.0    # ⬆️ เพิ่มอัตราเร่ง ให้ขยับเข้าหาเป้าหมายสมูทๆ
        SPEED_MULTIPLIER = 110.0 # ⬆️ เพิ่มตัวคูณให้ PID ตอบสนองไวขึ้น
